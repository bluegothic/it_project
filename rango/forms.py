...
class TopicForm(forms.ModelForm):
    ...
    #     ('M', 'Multiple'),
    # )
    # type = forms.ChoiceField(widget=forms.RadioSelect(), choices=TYPES,help_text="Please enter the type.")
    # option1 = forms.CharField(required=False,help_text="Please enter the option 1.")
    # option2 = forms.CharField(required=False,help_text="Please enter the option 2.")
    # option3 = forms.CharField(required=False,help_text="Please enter the option 3.")
    # option4 = forms.CharField(required=False,help_text="Please enter the option 4.")
    # option5 = forms.CharField(required=False,help_text="Please enter the option 5.")
